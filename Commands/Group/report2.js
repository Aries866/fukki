    ...
    start: async (
      ...
      { text, prefix, isBotAdmin, isAdmin, pushName, metadata, args }
        ...
        if(!m.isGroup){
            ...
            let devs = [`918101187835@s.whatsapp.net`,`918602239106@s.whatsapp.net`,`918515848233@s.whatsapp.net`]
            ...
            try {
              ...
              let devs = [`918101187835@s.whatsapp.net`,`918602239106@s.whatsapp.net`,`918515848233@s.whatsapp.net`,`918231033230@s.whatsapp.net`]
